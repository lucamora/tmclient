...
class ThingsMobile {
    ...
    activateSim(msisdn, simBarcode, callback) {
        ...
        request.post(TM_API['activateSim'], { form, form }, function (err, resp, body) {
            if (err) {
    ...
    blockSim(msisdn, callback) {
        ...
        request.post(TM_API['blockSim'], { form, form }, function (err, resp, body) {
            if (err) {
                callback(error.network(err));
                return;
            }
    ...
    unblockSim(msisdn, callback) {
        ...
        request.post(TM_API['unblockSim'], { form, form }, function (err, resp, body) {
            if (err) {
                callback(error.network(err));
                return;
            }
    ...
    credit(callback) {
        ...
        request.post(TM_API['credit'], { form, form }, function (err, resp, body) {
            if (err) {
                callback(error.network(err));
                return;
            }
